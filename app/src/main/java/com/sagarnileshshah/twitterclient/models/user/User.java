...
public class User {
     ...
     */
    public User(Long id, String idStr, String name, String screenName, String location, String description, String url, Entities entities, Boolean _protected, Long followersCount, Long friendsCount, Long listedCount, String createdAt, Long favouritesCount, Object utcOffset, Object timeZone, Boolean geoEnabled, Boolean verified, Long statusesCount, String lang, Status status, Boolean contributorsEnabled, Boolean isTranslator, Boolean isTranslationEnabled, String profileBackgroundColor, String profileBackgroundImageUrl, String profileBackgroundImageUrlHttps, Boolean profileBackgroundTile, String profileImageUrl, String profileImageUrlHttps, String profileBannerUrl, String profileLinkColor, String profileSidebarBorderColor, String profileSidebarFillColor, String profileTextColor, Boolean profileUseBackgroundImage, Boolean hasExtendedProfile, Boolean defaultProfile, Boolean defaultProfileImage, Boolean following, Boolean followRequestSent, Boolean notifications) {
        this.remoteId = id;
        this.idStr = idStr;
        this.name = name;
